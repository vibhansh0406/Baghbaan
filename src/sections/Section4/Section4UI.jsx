  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse gap-12 md:gap-16 items-start md:items-center relative z-10">
        ...
        >
          <h4 className="text-terracotta font-inter tracking-[0.2em] uppercase text-xs md:text-sm mb-4">Highway Comforts</h4>
          <h3 className="font-playfair text-4xl sm:text-5xl md:text-6xl text-ivory mb-4 md:mb-6 leading-snug md:leading-tight">
            Wood-Fired <br/><span className="text-marigold italic font-playfair">Perfection</span>
          </h3>
          <p className="font-inter text-ivory/80 leading-relaxed mb-6 md:mb-8 text-base md:text-lg">
          ...
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
              ...
              <div>
                <h5 className="font-playfair text-xl md:text-2xl text-ivory mb-1">Classic Margherita</h5>
            ...
            <li className="flex items-start gap-4">
              <div className="w-1.5 h-1.5 mt-2 rounded-full bg-marigold shrink-0"></div>
              <div>
                <h5 className="font-playfair text-xl md:text-2xl text-ivory mb-1">Farmhouse Veggie Supreme</h5>
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                <h5 className="font-playfair text-xl md:text-2xl text-ivory mb-1">Tandoori Paneer Pizza</h5>
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 1 }}
            className="w-64 h-64 md:w-80 md:h-80 rounded-full border border-marigold/30 flex items-center justify-center relative bg-wood-brown/20"
          >
            ...
            <h3 className="font-tempting text-4xl md:text-5xl text-marigold opacity-80 text-center">Freshly<br/>Baked</h3>
          </motion.div>
        </div>
